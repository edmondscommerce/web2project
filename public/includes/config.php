...
$w2Pconfig['dbhost'] = '127.0.0.1';
$w2Pconfig['dbname'] = 'ross_newdotproject'; // Your web2Project Database Name
$w2Pconfig['dbuser'] = 'ross'; // Your MySQL Username
$w2Pconfig['dbpass'] = '1PoodlePoo'; // Your MySQL Password
